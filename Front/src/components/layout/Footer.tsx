...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900/60 backdrop-blur-sm border-t border-emerald-500/30 mt-20">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Sistema de gestión de proyectos del Centro VERTEX - Universidad de
              las Ciencias Informáticas. Desarrollado para optimizar el flujo de
              trabajo en proyectos de videojuegos y tecnologías inmersivas.
            </p>
          </div>
        ...
        {/* Copyright */}
        <div className="border-t border-emerald-500/30 mt-8 pt-6 text-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} VERTEXGesto. Todos los derechos reservados.
            Desarrollado para el Centro VERTEX
          </p>
        </div>
      </div>
    </footer>
