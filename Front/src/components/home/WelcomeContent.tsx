    ...
    <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {featuredGames.length === 0 ? (
            ...
            featuredGames.map((game) => (
              <div
                key={game.id}
                className="group bg-slate-900/50 backdrop-blur-sm border border-purple-500/20 rounded-2xl overflow-hidden hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-2"
              >
                ...
                <div className="p-5">
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-lg text-sm font-medium hover:from-purple-600/40 hover:to-pink-600/40 transition-all duration-300"
                  >
                    Ver Detalles
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="shrink-0 w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2 text-purple-300">Institución</h3>
                  <p className="text-gray-400 leading-relaxed">
                    VERTEX es el Centro de Desarrollo de Videojuegos y Tecnologías Inmersivas de la Facultad de Tecnologías Interactivas de la Universidad de las Ciencias Informáticas (UCI).
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-purple-300">Misión</h3>
                  <p className="text-gray-400 leading-relaxed">
                    Desarrollar videojuegos innovadores y soluciones de realidad virtual/aumentada que impulsen la industria tecnológica cubana y formen profesionales de excelencia.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-purple-300">Visión</h3>
                  <p className="text-gray-400 leading-relaxed">
                    Convertirnos en el centro de referencia nacional en desarrollo de videojuegos y tecnologías inmersivas, reconocidos por la calidad e innovación de nuestros proyectos.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-purple-300">Tecnologías</h3>
                  <p className="text-gray-400 leading-relaxed">
                    Trabajamos con Unity, Unreal Engine, realidad virtual (VR), realidad aumentada (AR), y las últimas tecnologías de desarrollo de videojuegos.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="text-center mb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {["Unity", "Unreal Engine", "Blender", "C#", "C++", "Python"].map((tech, idx) => (
            <div
              key={idx}
            ...
            >
              <div className="text-lg font-semibold text-purple-300">{tech}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-12 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          ¿Quieres conocer más sobre VERTEX?
        </h2>
        <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
          Descubre todos nuestros proyectos, únete a nuestro equipo o colabora con nosotros en el desarrollo de videojuegos innovadores.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105">
            Ver Proyectos
          </button>
